# Deploy DVulnDB Anchor programs to Solana Testnet
# This script deploys all Solana programs to testnet for staging

Write-Host "🚀 Deploying DVulnDB to Solana Testnet..." -ForegroundColor Green
...
Write-Host "🔧 Configuring Solana for testnet deployment..." -ForegroundColor Blue
...
# Deploy programs
Write-Host "🚀 Deploying programs to testnet..." -ForegroundColor Blue
try {
...
Write-Host "🎉 Testnet deployment completed successfully!" -ForegroundColor Green
Write-Host "Programs deployed to Solana Testnet" -ForegroundColor Cyan